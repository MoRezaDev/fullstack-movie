...
export async function getMovie(imdb_id: string) {
  ...
  const response = await fetch(
    `${import.meta.env.VITE_BASE_URL}/movie/${validated.data.imdb_id}`
  );
...
export async function findOrAddMovie(imdb_id: string) {
  ...
  const response = await fetch(
    `${import.meta.env.VITE_BASE_URL}/movie/find-add?imdb_id=${imdb_id}`
  );
...
export async function updateMovie(imdb_id: string, updateDto: movieType) {
  ...
  const response = await fetch(
    `${import.meta.env.VITE_BASE_URL}/movie/${imdb_id}`,
    {
      method: "PATCH",
...
export async function getSeries(imdb_id: string) {
  ...
  const response = await fetch(
    `${import.meta.env.VITE_BASE_URL}/series/${imdb_id}`
  );
...
export async function findOrAddSeries(imdb_id: string) {
  ...
  const response = await fetch(
    `${import.meta.env.VITE_BASE_URL}/series/find-add?imdb_id=${imdb_id}`
  );
...
export async function getAllSeries() {
  ...
  const response = await fetch(`${import.meta.env.VITE_BASE_URL}/series`);
...
export async function getAnime(mal_id: string) {
  ...
  const response = await fetch(
    `${import.meta.env.VITE_BASE_URL}/anime/${mal_id}`
  );
...
export async function findOrAddAnime(mal_id: string) {
  ...
  const response = await fetch(
    `${import.meta.env.VITE_BASE_URL}/anime/find-add?mal_id=${mal_id}`
  );
...
export async function getAllAnimes() {
  ...
  const response = await fetch(`${import.meta.env.VITE_BASE_URL}/anime`);
